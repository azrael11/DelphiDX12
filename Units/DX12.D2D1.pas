...
type
    ...
    ID2D1Bitmap = interface(ID2D1Image)
        ...
        procedure GetSize(out ASize: TD2D1_SIZE_F); stdcall;

        // Returns the size of the bitmap in resolution dependent units, (pixels).
        procedure GetPixelSize(out APixelSize: TD2D1_SIZE_U); stdcall;

        // Retrieve the format of the bitmap.
        procedure GetPixelFormat(out APixelFormat: TD2D1_PIXEL_FORMAT); stdcall;
        ...
        function CopyFromBitmap(destPoint: PD2D1_POINT_2U; bitmap: ID2D1Bitmap; srcRect: PD2D1_RECT_U): HResult;
            stdcall;
